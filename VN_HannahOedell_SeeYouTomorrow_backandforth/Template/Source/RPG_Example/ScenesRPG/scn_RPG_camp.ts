namespace VNamespace {
    ...
    export async function scn_RPG_camp(): ƒS.SceneReturn { //Fs. um fudge story funktionen aufzurufen
        ...
        await ƒS.Location.show(rpgLocations.BG_camp);
        ...
        switch (decision) {
            case decisionButtons.dec_portal:
                await ƒS.Location.show(rpgLocations.BG_portal);
                ƒS.update(3);
            ...
            case decisionButtons.dec_leave:
                await ƒS.Location.show(rpgLocations.BG_ventureout);
                ...
                await ƒS.update(2);
                await ƒS.Location.show(rpgLocations.BG_ventureoutfurther);
                await ƒS.update(2);
                break;
            default:
