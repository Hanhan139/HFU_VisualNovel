...
(function (VNamespace) {
    async function scn_RPG_camp() {
        ...
        await VNamespace.ƒS.Location.show(VNamespace.rpgLocations.BG_camp);
        ...
        switch (decision) {
            case decisionButtons.dec_portal:
                await VNamespace.ƒS.Location.show(VNamespace.rpgLocations.BG_portal);
            ...
            case decisionButtons.dec_leave:
                await VNamespace.ƒS.Location.show(VNamespace.rpgLocations.BG_ventureout);
                ...
                await VNamespace.ƒS.Location.show(VNamespace.rpgLocations.BG_ventureoutfurther);
                await VNamespace.ƒS.update(2);
                break;
            default:
...
(function (VNamespace) {
    async function scn_RPG_compAmie() {
        ...
        let loop = true;
        await VNamespace.ƒS.Location.show(VNamespace.rpgLocations.BG_fire);
        await VNamespace.ƒS.update(2, "./Assets/Transitions/TR_dots_default.png", 1);
...
(function (VNamespace) {
    async function scn_RPG_comp() {
        ...
        await VNamespace.ƒS.Location.show(VNamespace.rpgLocations.BG_companions);
